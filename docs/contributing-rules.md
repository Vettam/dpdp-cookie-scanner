...
- Community contributions are welcome. Each record must cite where its classification came from in its `provenance` field: vendor documentation, direct observation, or a named list with compatible licence terms.
